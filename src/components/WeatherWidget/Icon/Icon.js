...
import stockImage from '../../../assets/images/sunny.jpg';
import './Icon.css';
...
const Icon = (props) => {
    ...
    if ((props.iconType === 'Overcast') || (props.iconType === 'Clouds')) {
        return (
    ...
    else if (props.iconType === 'Thunderstorms') {
        return (
            <div className="container">
      <div className="elements">
        <div className="element">
    ...
    else if ((props.iconType === 'Sunny') || (props.iconType === 'clear sky') || (props.iconType === 'Clear')) 
    {
      return (
      <div className="container">
      <div className="elements">
        <div className="element">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 44.9 44.9" style={{enableBackground:"new 0 0 44.9 44.9;"}} xmlSpace="preserve" height="80px" width="80px">
            <g id="Sun">
    ...
    else if (props.iconType === 'Clear Night') {
      return (
      <div className="container">
        <div className="elements">
          <div className="element">
    ...
    else if (props.iconType === 'Cloudy Night') {
      return (
        <div className="container">
          <div className="elements">
            <div className="element">
    ...
    else if ((props.iconType === 'Partly Sunny') || (props.iconType === 'broken clouds') || (props.iconType === 'few clouds')) {
      return (
        <div className="container">
          <div className="elements">
            <div className="element">
    ...
    else if (props.iconType === 'Windy') {
      return (
        <div className="container">
          <div className="elements">
            <div className="element">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 45.1 47.6" style={{enableBackground: "new 0 0 45.1 47.6;"}} xmlSpace="preserve" height="45px" width="45px">
            <g id="Wind_Sun">
    	        <g id="Sun_1_">
      ...
      return (
        ...
        return (
            <img src={stockImage} alt="Default" classNameName="TodayImage" />
        );
    }
